# ===================================================================================================
# Script para extração e exportação dos dados contidos nas Notas de Corretagem no padrão SINANCOR
...
def altera_ticket(stock, data):
    ...
    if stock == "JSLG3":
        ...
        if data < datalimite:
            ...
            print('As operações anteriores ao dia 19/09/2020 com o código "JSLG3" foram alteradas para o código "SIMH3".')
    return stock,log
